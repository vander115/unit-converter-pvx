#include <stdio.h>	// Biblioteca para trabalhar com funções de entrada e saï¿½da
...
double kmConversions(double km, Distance typeOfResult)
{
	...
	switch (typeOfResult)
	{
		...
		case LEAGUES:
			result = km * 0.207123; // 1 km = 0.207123 lï¿½guas
			break;
...
int main()
{
	...
	do
	{
		// Exibe o cabeçalho do programa usando códigos de cores ANSI
		do
		{
